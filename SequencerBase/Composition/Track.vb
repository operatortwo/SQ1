Public Class Track
    ...
    Public Sub PlayTrack(CurrentTime As Long, Voice As Voice, Track As Track)
        ...
        Do
            ...
            If CurrentTime < pat.StartTime + pat.Duration Then      ' avoid restarted pattern play first note
    ...
    Public Sub PlayTrack_old(CurrentTime As Long, Voice As Voice, Track As Track)
